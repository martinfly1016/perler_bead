...
function drawMiniMap() {
    ...
    miniMapCtx.fillRect(0, 0, miniMapSize, miniMapSize); // Use CSS size for drawing context
    ...
    const miniMapScaleX = miniMapSize / worldWidth; // Use CSS size for scale calculation
